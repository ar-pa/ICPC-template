...
// at the end of method, res[i] will be c_i in sigma(i:0->n): c_i*A^i which is characteristic polynomial of A and equal to det(tI-A).
// so (-1)^n*c_0 is the determinant of A.
// c_n will be 1. for more information, go to Parsa Abdollahi :)
